...
namespace OCSServices.Matrixx.Api.Client.Internal.Balance
{
    ...
    public class GroupAddThreshold : BaseApiOperation, IPostApiOperation<GroupAddThresholdRequest, MatrixxResponse>
    {

        internal GroupAddThreshold(Endpoint endpoint) : base(endpoint)
        {
        }
        public Task<MatrixxResponse> Execute(GroupAddThresholdRequest payLoad)
        {
            return Post<GroupAddThresholdRequest, MatrixxResponse>(payLoad);
        }
    }
}
